...
#基础设置
dataset_root_path= '/home/chang/my/Pole_Measurement/mydata/label/' #"mydata/label/"  #'/media/chang/DATADRIVE1/my_train_dataset/label_2D/'
...
dataset_val.load_shapes(int(count*0.3), img_floder, mask_floder, imglist,dataset_root_path)
dataset_val.prepare()
...
if init_with == "imagenet":
    ...
    model.load_weights('/home/chang/my/mask_rcnn/logs/shapes20220808T0841/mask_rcnn_shapes_0015.h5', by_name=True)
